...
if ($showform == "atd"){
	...
	$sql = "SELECT example_testdata.intput,example_testdata.ordinal FROM `example_testdata` WHERE `example_testdata`.`e_id` =".$e_id." ORDER BY `example_testdata`.`ordinal` ASC";
	...
	$obj = json_decode($stu_output_json);
	...
	//處理Json並撈 資料比對
	$sql = "SELECT example_testdata.output,example_testdata.feedback_info,example_testdata.ordinal,`example_testdata`.`testcase_title` FROM `example_testdata` WHERE `example_testdata`.`e_id` =".$e_id." ORDER BY `example_testdata`.`ordinal` ASC";
	$result = mysqli_query($conn, $sql);
	...
	$sql = "SELECT `example_testdata`.`ordinal`, `example_testdata`.`testcase_title`,`example_testdata`.`feedback_info` FROM `example_testdata` WHERE e_id = ".$e_id." ORDER BY `example_testdata`.`ordinal`;";
