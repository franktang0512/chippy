...
Blockly.JavaScript['text_s'] = function(block) {
  ...
  if(parseFloat(code.replaceAll("\'","")).toString()!="NaN"){
    if(isFinite(code.replaceAll("\'","")))
      {code = "Number( "+  code +  ")";}
...
Blockly.JavaScript['join'] = function(block) {
  var code = Blockly.JavaScript.quote_(Blockly.JavaScript.valueToCode(block, 'TEXT0',
      Blockly.JavaScript.ORDER_NONE).replaceAll("\'", "") + Blockly.JavaScript.valueToCode(block, 'TEXT1',
      Blockly.JavaScript.ORDER_NONE).replaceAll("\'", ""));
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};
...
Blockly.JavaScript['removeAll_list'] = function(block) {
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
  var code = list_name + ' = [];\n'
  return code
...
Blockly.JavaScript['ask'] = function(block) {
  ...
  var code = 'system_input = window.prompt(' + value_question + ')\n' + 
  'if( parseFloat(system_input).toString() != "NaN" ) {\n' + 
