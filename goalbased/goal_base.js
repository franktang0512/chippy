...
toolbox_scratch += '<block type="repeat_ext_ch">'+
				'<value name="TIMES">'+
					'<shadow type="math_number">'+
						'<field name="NUM">10</field>'+
					'</shadow>'+
...
function show_question() {
	...
	document.getElementById('question').style.height='100%';
	document.getElementById('canvas_div').style.display='none';
	document.getElementById('canvas_div').style.height='100%';
}
...
function show_both() {
	document.getElementById('question').style.display='block';
	document.getElementById('question').style.height='20%';
	document.getElementById('canvas_div').style.display='block';
	document.getElementById('canvas_div').style.height='70%';
}
