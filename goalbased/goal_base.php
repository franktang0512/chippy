    ...
    <div id="view" class="column canvas-bg" style="position: relative;">
        ...
        <div id="canvas_div" style="display: none;">
            ...
            <div style="text-align:center;">
                ...
                <button id="sent" class="btn btn-lg" style="background-color: blue; color: white;" onclick="judgeCode();<?php echo ($_SESSION["u_level"]=='0'? "submit_answer();":($_SESSION["u_level"]=='1'?"submit_answer_tea();":"")) ?>" 
				<?php //老師端先不要給提交，
