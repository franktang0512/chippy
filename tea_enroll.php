        ...
        <div class="container justify-content-center text-center workspace classregister mt-2 mb-5">
            ...
            <form id="classregisterform" action="tea_enroll_.php" class="form-registered" method="post">
                ...
                <div class="form-group row ml-3">
                    ...
                    <div class="col-md-10 justify-content-left text-left">
                        <input type="radio" id="G00" name="G00" value="1" onclick="getExamLevelselect('G00');">
                        <label class="px-2" for="G00">練習</label>&nbsp;&nbsp;
                        <input type="radio" id="G1" name="G1" value="1" onclick="getExamLevelselect('G1');">
                        <label class="px-2" for="G1">目標導向基礎</label>&nbsp;&nbsp;
                        <input type="radio" id="G2" name="G2" value="1" onclick="getExamLevelselect('G2');">
                        <label class="px-2" for="G2">目標導向挑戰</label>&nbsp;&nbsp;
                        <input type="radio" id="G3" name="G3" value="1" onclick="getExamLevelselect('G3');">
                        <label class="px-2" for="G3">運算思維與程式設計(高中)</label>&nbsp;&nbsp;<br>
                        <input type="radio" id="P1" name="P1" value="1" onclick="getExamLevelselect('P1');">
                        <label class="px-2" for="P1">問題導向基礎</label>&nbsp;&nbsp;
                        <input type="radio" id="P2" name="P2" value="1" onclick="getExamLevelselect('P2');">
                        <label class="px-2" for="P2">問題導向進階</label>&nbsp;&nbsp;
                        <input type="radio" id="P3" name="P3" value="1" onclick="getExamLevelselect('P3');">
                        <label class="px-2" for="P3">問題導向挑戰</label>&nbsp;&nbsp;
                    </div>
                </div>
                <div class="form-group row ml-3">
