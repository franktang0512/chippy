...
*/
//test
Blockly.JavaScript['test_ch'] = function(block) {
...
//Text
Blockly.JavaScript['text_s_ch'] = function(block) {
  // Text value.
  var code = Blockly.JavaScript.quote_(block.getFieldValue('TEXT'));
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.JavaScript['print_ch'] = function(block) {
  // Print statement.
...
Blockly.JavaScript['length_ch'] = function(block) {
...
Blockly.JavaScript['join_ch'] = function(block) {
...
//Logic
Blockly.JavaScript['if_ch'] = function(block) {
  var n = 0;
...
Blockly.JavaScript['ifelse_ch'] = Blockly.JavaScript['if_ch'];

Blockly.JavaScript['boolean_ch'] = function(block) {
  var code = Boolean(block.getFieldValue('BOOL'));
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.JavaScript['boolean_true_ch'] = function(block) {
  // Boolean values true and false.
  var code = (block.getFieldValue('BOOL') == 'TRUE') ? 'true' : 'false';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.JavaScript['compare_ch'] = function(block) {
  // Comparison operator.
  var OPERATORS = {
    'EQ': '==',
    'NEQ': '!=',
...
Blockly.JavaScript['operation_ch'] = function(block) {
  // Operations 'and', 'or'.
...
Blockly.JavaScript['negate_ch'] = function(block) {
  // Negation.
...
//Loops
Blockly.JavaScript['repeat_ext_ch'] = function(block) {
  // Repeat n times.
...
Blockly.JavaScript['whileUntil_ch'] = function(block) {
  // Do while/until loop.
...
Blockly.JavaScript['flow_statements_ch'] = function(block) {
...
//Math
Blockly.JavaScript['number_ch'] = function(block) {
  // Numeric value.
...
Blockly.JavaScript['arithmetic_ch'] = function(block) {
...
Blockly.JavaScript['single_trig_ch'] = function(block) {
...
Blockly.JavaScript['round_ch'] = Blockly.JavaScript['single_trig_ch'];

Blockly.JavaScript['modulo_ch'] = function(block) {
...
Blockly.JavaScript['random_int_ch'] = function(block) {
...
//Variables
Blockly.JavaScript['get_ch'] = function(block) {
  // Variable getter.
...
Blockly.JavaScript['set_ch'] = function(block) {
  // Variable setter.
...
Blockly.JavaScript['change_ch'] = function(block) {
...
Blockly.JavaScript['get_list_ch'] = function(block) {
...
Blockly.JavaScript['length_list_ch'] = function(block) {
  // array length.
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
...
Blockly.JavaScript['getIndex_list_ch'] = function(block) {
  var index = Blockly.JavaScript.valueToCode(block, 'AT',
      Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
  var code = list_name + '[' + (index-1) + ']'
  return [code, Blockly.JavaScript.ORDER_MEMBER];
};

Blockly.JavaScript['remove_list_ch'] = function(block) {
  var index = Blockly.JavaScript.valueToCode(block, 'AT',
      Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
...
Blockly.JavaScript['removeAll_list_ch'] = function(block) {
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
  var code = list_name + ' = [];\n'
  return code
...
Blockly.JavaScript['setIndex_list_ch'] = function(block) {
  var index = Blockly.JavaScript.valueToCode(block, 'AT',
      Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
...
Blockly.JavaScript['insert_list_ch'] = function(block) {
  var index = Blockly.JavaScript.valueToCode(block, 'AT',
      Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
  var value = Blockly.JavaScript.valueToCode(block, 'VALUE',
      Blockly.JavaScript.ORDER_ASSIGNMENT);
...
Blockly.JavaScript['add_list_ch'] = function(block) {
  var value = Blockly.JavaScript.valueToCode(block, 'VALUE',
      Blockly.JavaScript.ORDER_ASSIGNMENT) || '0';
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
...
//Function
Blockly.JavaScript['function_create_ch'] = function(block) {
...
Blockly.JavaScript['function_call_ch'] = function(block) {
  var text_name = block.getFieldValue('NAME');
  //var statements_do = Blockly.JavaScript.statementToCode(block, 'DO');
  // TODO: Assemble JavaScript into code variable.
  var code = text_name + '(';
...
Blockly.JavaScript['function_define_ch'] = function(block) {
  var text_name = block.getFieldValue('NAME');
  var statements_do = Blockly.JavaScript.statementToCode(block, 'DO');
  // TODO: Assemble JavaScript into code variable.
...
Blockly.JavaScript['function_variable_ch'] = function(block) {
  // Variable getter.
  var code = Blockly.JavaScript.variableDB_.getName(
...
Blockly.JavaScript['blockly_print_ch'] = function(block) {
  // Print statement.
  var msg = Blockly.JavaScript.valueToCode(block, 'TEXT',
      Blockly.JavaScript.ORDER_NONE) || '\'\'';
  var code = 'output_result_string += ' + msg + '\n' + 'output_result_string += \'\\n\' \n'
